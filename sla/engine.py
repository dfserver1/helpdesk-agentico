...
class SLAEngine:
    ...
    def sla_target_seconds(self, priority: str) -> float:
        ...
        definition = SLA_DEFINITIONS.get(priority, SLA_DEFINITIONS["P3"])
        return definition["resolve_hours"] * 3600
    ...
    def compute_sla(self, ticket_id: str, priority: str, created_at: datetime = None) -> SLAStatus:
        """
